...
object IconRegistry {
    val MAP: Map<String, Int> = mapOf(
        ...
        "keyboard_split" to R.drawable.ic_keyboard_split,
        "keyboard_compact" to R.drawable.ic_keyboard_compact,
        "keyboard_full" to R.drawable.ic_keyboard_full,
        "landscape" to R.drawable.ic_keyboard_landscape,
